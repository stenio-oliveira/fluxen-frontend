...
import { BaseCancelButton } from "./BaseCancelButton";
    ...
    >
      ...
      >
        ...
        <Stack direction="row" alignItems="center" gap={2}>
          <BaseButton onClick={onConfirm} variant="contained">
            Sim
          </BaseButton>
          <BaseCancelButton onClick={onCancel} variant="contained" color="error">
            Não
          </BaseCancelButton>
        </Stack>
      </Box>
